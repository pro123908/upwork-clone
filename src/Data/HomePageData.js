...
export const trendingSkillsArray = [
  "Apple UIKit",
  "Apple Xcode",
...
export const topSkillsUSArray = [
  ...
  "Logo Designers in US",
  "Microsoft Office Specialists in US",
...
export const topCitiesUSArray = [
  "Atlanta, GA Freelancers",
  "Austin, TX Freelancers",
  "Boston, MA Freelancers",
